\begin{lstlisting}[language=SQL,caption={Query for answering: What proportion of total activity originates from collaborative versus individual work},label={lst:kaq5},captionpos=b]
WITH base AS (
  SELECT
    t.year,
    t.month,
