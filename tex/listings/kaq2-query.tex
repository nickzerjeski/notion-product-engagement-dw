\begin{lstlisting}[language=SQL,caption={Query for answering: How does user engagement evolve over time across different content types?},label={lst:kaq2},captionpos=b]
