...
Summary of `project-description.pdf` (annotations excluded) to guide the team.
...
- **Task 6 — Data Analysis Tool**: Produce an interactive dashboard (e.g., Pentaho, Grafana) or a manual mockup (e.g., Excel, gnuplot) that visualizes key results.
