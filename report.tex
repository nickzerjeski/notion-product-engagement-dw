...
\section*{Schema DDL}
\begin{itemize}
  \item Provide a single SQL script to create all dimension and fact tables, constraints, and indexes.
  \item Document surrogate keys, clustering, and partitioning choices (if any).
\end{itemize}

\section*{ETL Pipeline}
\begin{itemize}
  \item Describe extraction, cleaning, transformation, loading; include mapping rules and error handling.
  \item Record assumptions and simplifications; quantify any synthetic data generation.
\end{itemize}
\end{document}
